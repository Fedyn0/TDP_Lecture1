...
class Controller:
    ...
    def add_ordine(self, e):
        ...
        if mail == "":
            self._view._lvOut.controls.append(ft.Text("Attenzione, il campo mail non può essere vuoto",
                                                      color = "RED"))
            self._view.update_page()
            return
        ...
        if categoria == "":
            self._view._lvOut.controls.append(ft.Text("Attenzione, il campo categoria non può essere vuoto",
                                                      color = "RED"))
            self._view.update_page()
            return
