...
class View:
    def __init__(self, page):
        ...
        self._page.title = "TdP - Software Gestionale"
    ...
    def carica_interfaccia(self):
        ...
        self._btnAdd = ft.ElevatedButton(text = "Aggiungi Ordine",
                                         ...
                                         width = 200)
        self._GestisciOrdine = ft.ElevatedButton(text = "Gestisci prossimo ordine",
        ...
        self._btnStampaInfo = ft.ElevatedButton(text = "Stampa sommario",
                                         ...
                                         width = 200)
        row3 = ft.Row(controls = [self._btnAdd, self._GestisciOrdine,
